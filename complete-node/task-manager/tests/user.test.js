...
test('Should not delete account for unauthenticate user', async (done) => {
    await request(app)
        .delete('/users/me')
        .send()
        .expect(401)
...
test('Should upload avatar image', async (done) => {
    ...
    // toBe use === operator to compare if 2 objects are same objects
    // toEqual use algorithm to compare object with other object
})
